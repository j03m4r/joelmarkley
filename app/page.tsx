    ...
    return (
        <main className="flex w-full max-w-[1280px] mt-[10rem] min-h-screen">
            ...
            <div className="flex-1 pl-[4rem]">
                ...
                <p className='text-xl mb-[2rem]'>My research interests lie at the intersection of human cognition and online communities. I'm interested in how we can develop systems to support online communities that focus on developing prosocial behavior among users instead of maintaining the immediate quality of the communities information ecosystem. <b>Currently, I'm investigating how we can personalize and scale proactive moderation with a conversational moderation intervention that accounts for user characteristics.</b></p>
                <div className='w-full flex items-center gap-x-[.5rem] mt-[4rem] mb-[1rem]'>
                ...
                {
                    news.map((_news) => (
                        <div className='w-full flex items-center gap-x-[4rem]'>
